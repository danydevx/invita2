    ...
    public function run(): void
    {
        $presets = [
            ...
            [
                ...
                'greeting_message' => '¡Hey! Soy tu asistente de estilo en {business_name}. ¿Buscando algo especial o quieres que te sorprendas? Cuéntame qué tienes en mente 😊',
        ...
        foreach ($presets as $preset) {
            if (!ChatbotPreset::where('slug', $preset['slug'])->whereNull('listing_id')->exists()) {
