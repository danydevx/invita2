...
namespace Modules\Guests\Http\Controllers\Member;
...
class GuestController extends Controller
{
    public function index(Request $request, $listing)
    {
        ...
        $guests = BusinessGuest::where('listing_id', $listing->id)
    ...
    public function store(Request $request, $listing)
    {
        ...
        $guest = BusinessGuest::create([
            ...$validated,
            'listing_id' => $listing->id,
            'confirmation_token' => BusinessGuest::generateToken(),
        ]);
    ...
    public function update(Request $request, $listing, $id)
    {
        ...
        $guest = BusinessGuest::where('listing_id', $listing->id)
            ->where('id', $id)
            ->firstOrFail();
