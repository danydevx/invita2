<template>
  <AdminLayout>
    ...
    <div class="d-flex flex-wrap align-items-center justify-content-between mb-4">
      ...
      <Link :href="`/admin/listings/${business.id}/products/create`" class="btn btn-primary btn-sm">
          ...
          <table class="table table-hover align-middle mb-0">
            ...
            <tbody>
              ...
              <tr v-for="prod in products.data" :key="prod.id">
                ...
                <td class="text-end">
                  <Link :href="`/admin/listings/${business.id}/products/${prod.id}/edit`" class="btn btn-sm btn-outline-primary">
                    Editar
                  </Link>
                </td>
              </tr>
