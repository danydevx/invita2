        ...
        <form @submit.prevent="submit">
          <div class="row g-3">
            ...
            <div class="col-12">
              ...
              <Link :href="`/admin/listings/${listing.id}/products`" class="btn btn-outline-secondary ms-2">
                Cancelar
              </Link>
            </div>
          </div>
...
const submit = () => {
  router.put(`/admin/listings/${listing.value.id}/products/${product.value.id}`, form)
}
</script>
