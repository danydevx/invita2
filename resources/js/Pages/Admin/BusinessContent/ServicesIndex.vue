  ...
  <AdminLayout>
    ...
    <div class="d-flex flex-wrap align-items-center justify-content-between mb-4">
      ...
      <div class="d-flex gap-2">
        <Link :href="`/admin/listings/${listing.id}/service-categories`" class="btn btn-outline-secondary btn-sm">
          ...
          <table class="table table-hover align-middle mb-0">
            ...
            <tbody>
              ...
              <tr v-for="svc in services.data" :key="svc.id">
                ...
                <td class="text-end">
                  <Link :href="`/admin/listings/${listing.id}/services/${svc.id}/edit`" class="btn btn-sm btn-outline-primary">
                    Editar
                  </Link>
                </td>
              </tr>
